"""
Static reef site definitions for Hawaii.
mmm_c = Maximum Monthly Mean SST (°C) — NOAA CRW baseline used for bleaching threshold calc.
Bleaching Watch triggers at MMM + 1°C, Warning at MMM + 2°C.
"""
